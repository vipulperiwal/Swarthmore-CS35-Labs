...
template <typename V, typename W> class Graph {
  public:
     ...
     *                       and target.
     */
    virtual void insertEdge(V src, V dest, W weight) = 0;
     ...
     */
    virtual vector<Edge<V, W>> getOutgoingEdges(V source) = 0;
     ...
     */
    virtual vector<Edge<V, W>> getIncomingEdges(V destination) = 0;
